# Plan: Visualising Fruit Fly Neurons
...
uppercase labels. Blue marks one thing per view. Sentence case (except the product name, "Visualising Fruit Fly Neurons", at the user's request), no exclamation marks. Tap targets ≥ 44 px on
